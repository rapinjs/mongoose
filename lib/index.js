    ...
    afterInitRegistry({ config, registry }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const mongooseClient = yield mongoose_1.default.connect(config.mongoose.uri, Object.assign({ useFindAndModify: false, useNewUrlParser: true, useUnifiedTopology: true, autoReconnect: true }, options));
